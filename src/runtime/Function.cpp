...
//     DEBUG_LOG("Function has " + std::to_string(parameters.size()) + " parameters");
...
//                 DEBUG_LOG("Argument is an assignment statement");
...
//                 DEBUG_LOG("Argument is a constant assignment");
//                 auto clonedAssignment = assignment->clone();
//                 evaluatedValue = Expression::evaluate(clonedAssignment->getValue(), scope).value();
...
//             }
//         } else {
//             DEBUG_LOG("Argument is not an assignment statement");
//             evaluatedValue = Expression::evaluate(arg, scope).value();

//             DEBUG_LOG("Setting parameter '" + paramNames[argPos] + "' to '" + valueToString(evaluatedValue) + "'");
...
//             DEBUG_LOG("Function '" + name + "' returning a value");
...
//             DEBUG_LOG("Function '" + name + "' returning " + valueToString(value) + " from nested statement");
//             return value;
//         }
//     }

//     DEBUG_LOG("Function '" + name + "' executed and returned void.\n");
