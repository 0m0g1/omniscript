...
//     if (value.has_value()) {
//         DEBUG_LOG("Setting variable: " + name + " with value: " + valueToString(value.value()));
//     } else {
//         DEBUG_LOG("Setting variable: " + name + " with value: null");
//     }
...
//         DEBUG_LOG("Checking variable '" + name + "' in scope " + currentTable->name);
...
//             DEBUG_LOG("Setting the variable '" + name + "' on scope '" + currentTable->name + "' with value " +
...
//     DEBUG_LOG("Setting the variable '" + name + "' on the scope '" + this->name + "' with value " +
//                   (value.has_value() ? valueToString(value.value()) : "null"));
...
//         DEBUG_LOG("Currently looking for the symbol '" + name + "' in scope '" + currentScope->name + "'");
...
//             DEBUG_LOG("Found the generic function: " + name);
//             return it->second; // Return the function value
//         }

//         if (auto it = currentScope->objects.find(name); it != currentScope->objects.end()) {
//             DEBUG_LOG("Found the object: " + name);
...
//     DEBUG_LOG("Did not find the symbol: " + name);
...
//     objects[name] = obj;
//     DEBUG_LOG("added object '" + name + "' to the scope");
// }
